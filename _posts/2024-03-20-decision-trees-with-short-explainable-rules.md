...
sitemap: true
robots: index,follow
description: "Learn how decision trees can optimize for shorter explanations by reducing the number of distinct attributes used in prediction rules."
...
<figure>
  <img src="/assets/blog/decision-trees-with-short-explainable-rules/cover.png" alt="CART and SER-DT trees for the Sensorless dataset" width="1040" height="263" loading="eager" decoding="async" fetchpriority="high">
...
<figure>
  <img src="/assets/blog/decision-trees-with-short-explainable-rules/figure-02.png" alt="Rules generated by CART and SER-DT" width="554" height="164" loading="lazy" decoding="async">
...
![](/assets/blog/decision-trees-with-short-explainable-rules/figure-03.png){: width="381" height="66" loading="lazy" decoding="async" }
...
![](/assets/blog/decision-trees-with-short-explainable-rules/figure-04.png){: width="461" height="76" loading="lazy" decoding="async" }
...
![](/assets/blog/decision-trees-with-short-explainable-rules/figure-05.png){: width="486" height="150" loading="lazy" decoding="async" }
...
![](/assets/blog/decision-trees-with-short-explainable-rules/figure-06.png){: width="1096" height="508" loading="lazy" decoding="async" }
...
![](/assets/blog/decision-trees-with-short-explainable-rules/figure-07.png){: width="337" height="92" loading="lazy" decoding="async" }

For a candidate split, weighted Gini impurity combines the impurity of the left and right children.

![](/assets/blog/decision-trees-with-short-explainable-rules/figure-08.png){: width="523" height="92" loading="lazy" decoding="async" }
...
<figure>
  <img src="/assets/blog/decision-trees-with-short-explainable-rules/figure-09.png" alt="Average accuracy and explanation size over 20 datasets as a function of FactorExpl" width="1034" height="227" loading="lazy" decoding="async">
...
<figure>
  <img src="/assets/blog/decision-trees-with-short-explainable-rules/figure-10.png" alt="Test accuracy, average explanation size, and worst-case explanation size for SER-DT and CART" width="922" height="678" loading="lazy" decoding="async">
